...
outfile_meta.write("taxid"+'\t'+"taxonomy"+'\t'+"tax1"+'\t'+"tax2"+'\t'+"tax3"+'\t'+"tax4"+'\t'+"tax5"+'\t'+"tax6"+'\t'+"tax7"+'\t'+"tax8"+'\t'+"tax9"+'\t'+"tax10"+'\t'+"tax11"+'\t'+"tax12"+'\t'+"tax13"+'\t'+"tax14"+'\n')
...
for key in swarms.keys():
    if key in node_hits.keys():
        x = taxa_ref[node_hits[key][1]][1].split(";")# change this back to ";" if using the pr2taxonomy
